...
string ClusterFitCommand::getHelpString(){
    try {
        ...
        helpString += "The refweight parameter is used with the denovo method to allows you weight the selection of reference seqeunces. Options none, abundance and connectivity. Default=none.\n";
