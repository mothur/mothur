...
/***********************************************************/
void TreeGroupCommand::printSims(ostream& out, vector< vector<double> >& simMatrix, vector<string> groupNames) {
    try {
...
/***********************************************************/
vector< vector<double> > TreeGroupCommand::makeSimsDist(SparseDistanceMatrix* matrix, int numGroups) {
	try {
