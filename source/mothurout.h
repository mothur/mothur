...
class MothurOut {
	...
	public:
        ...
        int openInputFileBinary(string, boost::iostreams::filtering_istream&);
        int openInputFileBinary(string, boost::iostreams::filtering_istream&, string);
		int openInputFile(string, ifstream&, string); //no error given
        bool areGZFiles(vector<string>&);
