...
public:
    ...
    FakeOligos() {
        ...
        loadPaired() {
            primerNameVector.clear();
            barcodeNameVector.clear();
            oligosPair F01R2A; F01R2A.forward = "ccaac";	F01R2A.reverse = "cactg";	barcodeNameVector.psuh_back("F01R2A"); ipbarcodes[0] = F01R2A;
            oligosPair F01R2B; F01R2B.forward = "ccaac";	F01R2B.reverse = "aacca";	barcodeNameVector.psuh_back("F01R2B"); ipbarcodes[1] = F01R2B;
            oligosPair F01R2C; F01R2C.forward = "ccaac";	F01R2C.reverse = "tgtca";	barcodeNameVector.psuh_back("F01R2C"); ipbarcodes[2] = F01R2C;
            oligosPair F01R2D; F01R2D.forward = "ccaac";	F01R2D.reverse = "aaacc";	barcodeNameVector.psuh_back("F01R2D"); ipbarcodes[3] = F01R2D;
            oligosPair F02R2A; F02R2A.forward = "ggttg";	F02R2A.reverse = "cactg";	barcodeNameVector.psuh_back("F02R2A"); ipbarcodes[4] = F02R2A;
            oligosPair F02R2B; F02R2B.forward = "ggttg";	F02R2B.reverse = "aacca";	barcodeNameVector.psuh_back("F02R2B"); ipbarcodes[5] = F02R2B;
            oligosPair F02R2C; F02R2C.forward = "ggttg";	F02R2C.reverse = "tgtca";	barcodeNameVector.psuh_back("F02R2C"); ipbarcodes[6] = F02R2C;
            oligosPair F02R2D; F02R2D.forward = "ggttg";	F02R2D.reverse = "aaacc";	barcodeNameVector.psuh_back("F02R2D"); ipbarcodes[7] = F02R2D;
        }
    }
    ~FakeOligos() {}
